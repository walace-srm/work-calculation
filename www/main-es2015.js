...
const routes = [
    ...
    {
        path: 'calc-inss',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e("src_app_pages_calc-inss_calc-inss_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./pages/calc-inss/calc-inss.module */ 74304)).then(m => m.CalcInssPageModule)
    },
    {
        path: 'calc-irrf',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e("src_app_pages_calc-irrf_calc-irrf_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./pages/calc-irrf/calc-irrf.module */ 55538)).then(m => m.CalcIrrfPageModule)
    },
    {
        path: 'release-notes',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_pages_release-notes_release-notes_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./pages/release-notes/release-notes.module */ 63429)).then(m => m.ReleaseNotesPageModule)
    },
    {
        path: 'about',
    ...
    {
        path: 'calc-dissidio',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e("src_app_pages_calc-dissidio_calc-dissidio_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./pages/calc-dissidio/calc-dissidio.module */ 33939)).then(m => m.CalcDissidioPageModule)
    },
    {
        path: 'calc-decimo-terceiro',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e("src_app_pages_calc-decimo-terceiro_calc-decimo-terceiro_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./pages/calc-decimo-terceiro/calc-decimo-terceiro.module */ 73120)).then(m => m.CalcDecimoTerceiroPageModule)
    },
    {
        path: 'calc-periculosidade',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e("src_app_pages_calc-periculosidade_calc-periculosidade_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./pages/calc-periculosidade/calc-periculosidade.module */ 42463)).then(m => m.CalcPericulosidadePageModule)
    },
    {
        path: 'dicas',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_pages_dicas_dicas_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./pages/dicas/dicas.module */ 68256)).then(m => m.DicasPageModule)
    },
];
...
/* harmony import */ var _C_Users_Walace_Documents_work_calculation_node_modules_ngtools_webpack_src_loaders_direct_resource_js_app_component_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !./node_modules/@ngtools/webpack/src/loaders/direct-resource.js!./app.component.html */ 75158);
